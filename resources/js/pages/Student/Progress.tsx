...
import { Activity, Award, BarChart2, ChevronDown, ChevronUp, Home, LogOut, Menu, Trophy, User, X } from 'lucide-react';
        ...
        <div className="flex min-h-screen bg-gradient-to-b from-[#0a1e3c] to-[#0f2a4a]">
            ...
            <div className="fixed z-30 hidden h-full border-r border-[#1e3a5f] bg-[#0a1e3c] lg:flex lg:w-64 lg:flex-col">
                ...
                <nav className="flex-1 space-y-1 px-2 py-4">
                    ...
                    <Link href={getRoute('student.progress')} className="group flex items-center rounded-md bg-[#1e3a5f] px-4 py-3 text-white">
            ...
            >
                ...
                <nav className="flex-1 space-y-1 px-2 py-4">
                    ...
                    <Link href={getRoute('student.training')} className="flex items-center rounded-md px-4 py-3 text-[#a3c0e6] hover:bg-[#1e3a5f]/50">
                        <Activity className="mr-3 h-5 w-5 text-[#4a90e2]" />
                        <span>Training</span>
                    </Link>
                    <Link href={getRoute('student.progress')} className="flex items-center rounded-md bg-[#1e3a5f] px-4 py-3 text-white">
                        <BarChart2 className="mr-3 h-5 w-5 text-[#4a90e2]" />
                        <span>Progress</span>
                    </Link>
                    <div className="mt-4 border-t border-[#1e3a5f] pt-4">
