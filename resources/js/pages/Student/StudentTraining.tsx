                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <svg
                                            ...
                                            className={`h-5 w-5 transition-transform duration-200 ${expandedBlock === block.id ? 'rotate-180 transform' : ''}`}
                                            viewBox="0 0 20 20"
                                            fill="currentColor"
                                        >
                                            <path
                                                    ...
                                                    {week.sessions.map((session) => (
                                                        ...
                                                        >
                                                            {session.session_type !== 'rest' ? (
                                                                ...
                                                                <span className="block w-full cursor-default">{session.label}</span>
                                                            )}
                                                        </div>
                                                    ))}
                                                </div>
